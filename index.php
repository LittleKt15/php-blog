...
if (isset($_GET['id'])) {
    ...
    $id = $_GET['id'];
    $stmt = $db->prepare("SELECT blogs.id,blogs.title, blogs.content, blogs.image, blogs.created_at, users.name FROM blogs INNER JOIN users ON blogs.user_id = users.id WHERE blogs.category_id=$id ORDER BY blogs.id DESC");
} else {
    // get blogs
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="content p-3">
                                ...
                                <p>
                                    ...
                                    <a href="blog-detail.php?id=<?php echo $blog->id ?>" class="text-decoration-none">See More </a>
                                </p>
                            </div>
                        </div>
                    </div>
